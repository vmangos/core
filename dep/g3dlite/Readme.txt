...
G3D-v9.0 hotfix1a-vmangos.diff - 2026-05-14 - remove unused ray slope optimization dead code
G3D-v9.0 hotfix1b-vmangos.diff - 2026-05-14 - fix missing override on UprightSpline::ensureShortestPath
G3D-v9.0 hotfix1c-vmangos.diff - 2026-05-16 - fix mingw build: strncasecmp/strcasecmp redefinition by guarding with _MSC_VER instead of G3D_WINDOWS
...
G3D-v9.0 hotfix20a-vmangos.diff - 2026-05-16 - fix missing WINAPI calling convention on ExceptionIgnorer in GThread.cpp
