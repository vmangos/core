...
class MPQArchive
{
    ...
    public:
        ...
        unsigned int HashString(const char* Input, unsigned int Offset)
        {
        ...
        {
            unsigned int index = HashString(Filename, 0);
            index &= mpq_a.header->hashtablesize - 1;
            unsigned int name1 = HashString(Filename, 0x100);
            unsigned int name2 = HashString(Filename, 0x200);

            for (unsigned int i = index; i < mpq_a.header->hashtablesize; ++i)
            {
        ...
        void GetFileListTo(vector<string>& filelist)
        {
            ...
            unsigned int blockindex = hash.blockindex;
