...
enum EItemFields
{
    ...
    ITEM_FIELD_STACK_COUNT                           = OBJECT_END + 0x8,   // 0x00E - Size: 1 - Type: INT - Flags: OWNER_ONLY + ITEM_OWNER
    ITEM_FIELD_DURATION                              = OBJECT_END + 0x9,   // 0x00F - Size: 1 - Type: INT - Flags: OWNER_ONLY + ITEM_OWNER
    ITEM_FIELD_SPELL_CHARGES                         = OBJECT_END + 0xA,   // 0x010 - Size: 5 - Type: INT - Flags: OWNER_ONLY + ITEM_OWNER
    ...
    ITEM_FIELD_DURABILITY                            = OBJECT_END + 0x28,  // 0x02E - Size: 1 - Type: INT - Flags: OWNER_ONLY + ITEM_OWNER
    ITEM_FIELD_MAXDURABILITY                         = OBJECT_END + 0x29,  // 0x02F - Size: 1 - Type: INT - Flags: OWNER_ONLY + ITEM_OWNER
    ITEM_END                                         = OBJECT_END + 0x2A   // 0x030
};
enum EContainerFields
{
    CONTAINER_FIELD_NUM_SLOTS                        = ITEM_END + 0x0,     // 0x030 - Size: 1 - Type: INT - Flags: PUBLIC
    CONTAINER_ALIGN_PAD                              = ITEM_END + 0x1,     // 0x031 - Size: 1 - Type: BYTES - Flags: NONE
    CONTAINER_FIELD_SLOT_1                           = ITEM_END + 0x2,     // 0x032 - Size: 40 - Type: GUID - Flags: PUBLIC
    CONTAINER_END                                    = ITEM_END + 0x2A     // 0x05A
};
enum EUnitFields
{
    ...
    UNIT_FIELD_ATTACKPOWER                           = OBJECT_END + 0xA1,  // 0x0A7 - Size: 1 - Type: INT - Flags: PRIVATE + OWNER_ONLY
    ...
    UNIT_FIELD_RANGEDATTACKPOWER                     = OBJECT_END + 0xA5,  // 0x0AB - Size: 1 - Type: INT - Flags: PRIVATE + OWNER_ONLY
...
enum EPlayerFields
{
    PLAYER_SELECTION                                 = UNIT_END + 0x0,     // 0x0B0 - Size: 2 - Type: GUID - Flags: PUBLIC
    PLAYER_DUEL_ARBITER                              = UNIT_END + 0x2,     // 0x0B2 - Size: 2 - Type: GUID - Flags: PUBLIC
    PLAYER_FLAGS                                     = UNIT_END + 0x4,     // 0x0B4 - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_GUILDID                                   = UNIT_END + 0x5,     // 0x0B5 - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_GUILDRANK                                 = UNIT_END + 0x6,     // 0x0B6 - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_BYTES                                     = UNIT_END + 0x7,     // 0x0B7 - Size: 1 - Type: BYTES - Flags: PUBLIC
    PLAYER_BYTES_2                                   = UNIT_END + 0x8,     // 0x0B8 - Size: 1 - Type: BYTES - Flags: PUBLIC
    PLAYER_BYTES_3                                   = UNIT_END + 0x9,     // 0x0B9 - Size: 1 - Type: BYTES - Flags: PUBLIC
    PLAYER_DUEL_TEAM                                 = UNIT_END + 0xA,     // 0x0BA - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_GUILD_TIMESTAMP                           = UNIT_END + 0xB,     // 0x0BB - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_1_0                          = UNIT_END + 0xC,     // 0x0BC - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_1_PROPERTIES                 = UNIT_END + 0x14,    // 0x0C4 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_2_0                          = UNIT_END + 0x15,    // 0x0C5 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_2_PROPERTIES                 = UNIT_END + 0x1D,    // 0x0CD - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_3_0                          = UNIT_END + 0x1E,    // 0x0CE - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_3_PROPERTIES                 = UNIT_END + 0x26,    // 0x0D6 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_4_0                          = UNIT_END + 0x27,    // 0x0D7 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_4_PROPERTIES                 = UNIT_END + 0x2F,    // 0x0DF - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_5_0                          = UNIT_END + 0x30,    // 0x0E0 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_5_PROPERTIES                 = UNIT_END + 0x38,    // 0x0E8 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_6_0                          = UNIT_END + 0x39,    // 0x0E9 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_6_PROPERTIES                 = UNIT_END + 0x41,    // 0x0F1 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_7_0                          = UNIT_END + 0x42,    // 0x0F2 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_7_PROPERTIES                 = UNIT_END + 0x4A,    // 0x0FA - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_8_0                          = UNIT_END + 0x4B,    // 0x0FB - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_8_PROPERTIES                 = UNIT_END + 0x53,    // 0x103 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_9_0                          = UNIT_END + 0x54,    // 0x104 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_9_PROPERTIES                 = UNIT_END + 0x5C,    // 0x10C - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_10_0                         = UNIT_END + 0x5D,    // 0x10D - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_10_PROPERTIES                = UNIT_END + 0x65,    // 0x115 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_11_0                         = UNIT_END + 0x66,    // 0x116 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_11_PROPERTIES                = UNIT_END + 0x6E,    // 0x11E - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_12_0                         = UNIT_END + 0x6F,    // 0x11F - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_12_PROPERTIES                = UNIT_END + 0x77,    // 0x127 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_13_0                         = UNIT_END + 0x78,    // 0x128 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_13_PROPERTIES                = UNIT_END + 0x80,    // 0x130 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_14_0                         = UNIT_END + 0x81,    // 0x131 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_14_PROPERTIES                = UNIT_END + 0x89,    // 0x139 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_15_0                         = UNIT_END + 0x8A,    // 0x13A - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_15_PROPERTIES                = UNIT_END + 0x92,    // 0x142 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_16_0                         = UNIT_END + 0x93,    // 0x143 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_16_PROPERTIES                = UNIT_END + 0x9B,    // 0x14B - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_17_0                         = UNIT_END + 0x9C,    // 0x14C - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_17_PROPERTIES                = UNIT_END + 0xA4,    // 0x154 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_18_0                         = UNIT_END + 0xA5,    // 0x155 - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_18_PROPERTIES                = UNIT_END + 0xAD,    // 0x15D - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_19_0                         = UNIT_END + 0xAE,    // 0x15E - Size: 8 - Type: INT - Flags: PUBLIC
    PLAYER_VISIBLE_ITEM_19_PROPERTIES                = UNIT_END + 0xB6,    // 0x166 - Size: 1 - Type: TWO_SHORT - Flags: PUBLIC
    PLAYER_FIELD_PAD_0                               = UNIT_END + 0xB7,    // 0x167 - Size: 1 - Type: INT - Flags: NONE
    PLAYER_FIELD_INV_SLOT_HEAD                       = UNIT_END + 0xB8,    // 0x168 - Size: 46 - Type: GUID - Flags: PUBLIC
    PLAYER_FIELD_PACK_SLOT_1                         = UNIT_END + 0xE6,    // 0x196 - Size: 32 - Type: GUID - Flags: PRIVATE
    PLAYER_FIELD_BANK_SLOT_1                         = UNIT_END + 0x106,   // 0x1B6 - Size: 48 - Type: GUID - Flags: PRIVATE
    PLAYER_FIELD_BANKBAG_SLOT_1                      = UNIT_END + 0x136,   // 0x1E6 - Size: 12 - Type: GUID - Flags: PRIVATE
    PLAYER_FIELD_VENDORBUYBACK_SLOT                  = UNIT_END + 0x142,   // 0x1F2 - Size: 2 - Type: GUID - Flags: PRIVATE
    PLAYER_FARSIGHT                                  = UNIT_END + 0x144,   // 0x1F4 - Size: 2 - Type: GUID - Flags: PRIVATE
    PLAYER__FIELD_COMBO_TARGET                       = UNIT_END + 0x146,   // 0x1F6 - Size: 2 - Type: GUID - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_NPC                         = UNIT_END + 0x148,   // 0x1F8 - Size: 2 - Type: GUID - Flags: PRIVATE
    PLAYER_XP                                        = UNIT_END + 0x14A,   // 0x1FA - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_NEXT_LEVEL_XP                             = UNIT_END + 0x14B,   // 0x1FB - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_SKILL_INFO_1_1                            = UNIT_END + 0x14C,   // 0x1FC - Size: 384 - Type: TWO_SHORT - Flags: PRIVATE
    PLAYER_QUEST_LOG_1_1                             = UNIT_END + 0x2CC,   // 0x37C - Size: 60 - Type: INT - Flags: PRIVATE
    PLAYER_CHARACTER_POINTS1                         = UNIT_END + 0x308,   // 0x3B8 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_CHARACTER_POINTS2                         = UNIT_END + 0x309,   // 0x3B9 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_TRACK_CREATURES                           = UNIT_END + 0x30A,   // 0x3BA - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_TRACK_RESOURCES                           = UNIT_END + 0x30B,   // 0x3BB - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_CHAT_FILTERS                              = UNIT_END + 0x30C,   // 0x3BC - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_BLOCK_PERCENTAGE                          = UNIT_END + 0x30D,   // 0x3BD - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_DODGE_PERCENTAGE                          = UNIT_END + 0x30E,   // 0x3BE - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_PARRY_PERCENTAGE                          = UNIT_END + 0x30F,   // 0x3BF - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_CRIT_PERCENTAGE                           = UNIT_END + 0x310,   // 0x3C0 - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_EXPLORED_ZONES_1                          = UNIT_END + 0x311,   // 0x3C1 - Size: 32 - Type: BYTES - Flags: PRIVATE
    PLAYER_REST_STATE_EXPERIENCE                     = UNIT_END + 0x331,   // 0x3E1 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_COINAGE                             = UNIT_END + 0x332,   // 0x3E2 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_POSSTAT0                            = UNIT_END + 0x333,   // 0x3E3 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_POSSTAT1                            = UNIT_END + 0x334,   // 0x3E4 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_POSSTAT2                            = UNIT_END + 0x335,   // 0x3E5 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_POSSTAT3                            = UNIT_END + 0x336,   // 0x3E6 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_POSSTAT4                            = UNIT_END + 0x337,   // 0x3E7 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_NEGSTAT0                            = UNIT_END + 0x338,   // 0x3E8 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_NEGSTAT1                            = UNIT_END + 0x339,   // 0x3E9 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_NEGSTAT2                            = UNIT_END + 0x33A,   // 0x3EA - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_NEGSTAT3                            = UNIT_END + 0x33B,   // 0x3EB - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_NEGSTAT4                            = UNIT_END + 0x33C,   // 0x3EC - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE          = UNIT_END + 0x33D,   // 0x3ED - Size: 7 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE          = UNIT_END + 0x344,   // 0x3F4 - Size: 7 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS                 = UNIT_END + 0x34B,   // 0x3FB - Size: 7 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                 = UNIT_END + 0x352,   // 0x402 - Size: 7 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                 = UNIT_END + 0x359,   // 0x409 - Size: 7 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BYTES                               = UNIT_END + 0x360,   // 0x410 - Size: 1 - Type: BYTES - Flags: PRIVATE
    PLAYER_AMMO_ID                                   = UNIT_END + 0x361,   // 0x411 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_PVP_MEDALS                          = UNIT_END + 0x362,   // 0x412 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_ITEM_ID                     = UNIT_END + 0x363,   // 0x413 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_RANDOM_PROPERTIES_ID        = UNIT_END + 0x364,   // 0x414 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_SEED                        = UNIT_END + 0x365,   // 0x415 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_PRICE                       = UNIT_END + 0x366,   // 0x416 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_DURABILITY                  = UNIT_END + 0x367,   // 0x417 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_BUYBACK_COUNT                       = UNIT_END + 0x368,   // 0x418 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_FIELD_PADDING                             = UNIT_END + 0x369,   // 0x419 - Size: 1 - Type: INT - Flags: NONE
    PLAYER_END                                       = UNIT_END + 0x36A    // 0x41A
};
