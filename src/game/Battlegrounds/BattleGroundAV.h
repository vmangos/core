...
{
    // Graveyards
    BG_AV_GRAVEYARD_STORM_AID       = 15,
    BG_AV_GRAVEYARD_STORM_GRAVE     = 16,
    BG_AV_GRAVEYARD_STONE_GRAVE     = 17,
    BG_AV_GRAVEYARD_SNOWFALL        = 18,
    BG_AV_GRAVEYARD_ICE_GRAVE       = 19,
    BG_AV_GRAVEYARD_FROSTWOLF       = 20,
    BG_AV_GRAVEYARD_FROST_HUT       = 21,
