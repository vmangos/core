...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_AC_MOVEMENT_CHEAT_MULTI_JUMP_THRESHOLD,
    ...
    CONFIG_UINT32_AC_MOVEMENT_CHEAT_ROOT_MOVE_THRESHOLD,
    ...
    CONFIG_UINT32_AC_MOVEMENT_CHEAT_PENDING_ACK_DELAY_TIME,
