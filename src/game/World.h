...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_HY_TICK_TIMER = 0,
    CONFIG_UINT32_HY_CAPTURE_TIME,
    CONFIG_UINT32_HY_RESOURCE_BROADCAST_INTERVAL,
    CONFIG_UINT32_HY_BASE_COOLDOWN_MIN,
    CONFIG_UINT32_HY_BASE_COOLDOWN_MAX,
    CONFIG_UINT32_HY_BETWEEN_FIGHT_COOLDOWN,
    CONFIG_UINT32_HY_ATTACKABLE_BROADCAST_INTERVAL,
    CONFIG_UINT32_HY_FIGHT_DISABLE_HOUR_START,
    CONFIG_UINT32_HY_FIGHT_DISABLE_HOUR_END,
    CONFIG_UINT32_HY_PREPARATION_TIME,
    // Vanilla Reforged - Custom Rates End
    CONFIG_UINT32_COMPRESSION_LEVEL,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_XP_KILL_HORDE,
    CONFIG_FLOAT_RATE_XP_KILL_ELITE_HORDE,
    CONFIG_FLOAT_RATE_XP_KILL_ALLIANCE,
    CONFIG_FLOAT_RATE_XP_KILL_ELITE_ALLIANCE,
    // Vanilla Reforged - Custom Rates End
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_OUTDOORPVP_HY_ENABLE,
