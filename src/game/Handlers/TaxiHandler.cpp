...
void WorldSession::SendTaxiStatus(ObjectGuid guid)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WorldSession::SendTaxiStatus - %s not found or you can't interact with it.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleTaxiQueryAvailableNodes(WorldPacket& recv_data)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: HandleTaxiQueryAvailableNodes - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleActivateTaxiExpressOpcode(WorldPacket& recv_data)
{
    ...
    if (!npc)
    {
        sLog.outDebug("WORLD: HandleActivateTaxiExpressOpcode - %s not found or you can't interact with it.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleActivateTaxiOpcode(WorldPacket& recv_data)
{
    ...
    if (!npc)
    {
        sLog.outDebug("WORLD: HandleActivateTaxiOpcode - %s not found or you can't interact with it.", guid.GetString().c_str());
        return;
    }
