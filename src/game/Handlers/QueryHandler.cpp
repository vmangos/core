...
void WorldSession::HandleCreatureQueryOpcode(WorldPacket& recv_data)
{
    ...
    {
        sLog.outDebug("WORLD: CMSG_CREATURE_QUERY - Guid: %s Entry: %u NO CREATURE INFO!",
...
void WorldSession::HandleGameObjectQueryOpcode(WorldPacket& recv_data)
{
    ...
    {
        sLog.outDebug("WORLD: CMSG_GAMEOBJECT_QUERY - Guid: %s Entry: %u Missing gameobject info!",
