...
void WorldSession::HandleQuestgiverStatusQueryOpcode(WorldPacket& recv_data)
{
    ...
    if (!questgiver)
    {
        sLog.outDetail("Error in CMSG_QUESTGIVER_STATUS_QUERY, called for not found questgiver %s", guid.GetString().c_str());
        return;
    }

    //sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_STATUS_QUERY for %s", guid.GetString().c_str());
...
void WorldSession::HandleQuestgiverHelloOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_HELLO npc: %s", guid.GetString().c_str());

    Creature* pCreature = GetPlayer()->GetNPCIfCanInteractWith(guid, UNIT_NPC_FLAG_NONE);

    if (!pCreature)
    {
        sLog.outDebug("WORLD: HandleQuestgiverHelloOpcode - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleQuestgiverAcceptQuestOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_ACCEPT_QUEST giver = %s, quest = %u", guid.GetString().c_str(), quest);
...
void WorldSession::HandleQuestgiverQueryQuestOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_QUERY_QUEST npc = %s, quest = %u", guid.GetString().c_str(), quest);
...
void WorldSession::HandleQuestgiverChooseRewardOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_CHOOSE_REWARD npc = %s, quest = %u, reward = %u", guid.GetString().c_str(), quest, reward);
...
void WorldSession::HandleQuestgiverRequestRewardOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_REQUEST_REWARD npc = %s, quest = %u", guid.GetString().c_str(), quest);
...
void WorldSession::HandleQuestgiverCompleteQuest(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_QUESTGIVER_COMPLETE_QUEST npc = %s, quest = %u", guid.GetString().c_str(), quest);
