...
void WorldSession::HandleTabardVendorActivateOpcode(WorldPacket& recv_data)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: HandleTabardVendorActivateOpcode - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::SendTrainerList(ObjectGuid guid)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: SendTrainerList - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
    ...
    if (!cSpells && !tSpells)
    {
        sLog.outDebug("WORLD: SendTrainerList - Training spells not found for %s", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleTrainerBuySpellOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outDebug("WORLD: Received CMSG_TRAINER_BUY_SPELL Trainer: %s, learn spell id is: %u", guid.GetString().c_str(), spellId);
    ...
    if (!unit || !unit->IsTrainerOf(_player, true) || !unit->IsWithinLOSInMap(_player))
    {
        ...
        sLog.outDebug("WORLD: HandleTrainerBuySpellOpcode - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleGossipHelloOpcode(WorldPacket& recv_data)
{
    ...
    if (!pCreature)
    {
        sLog.outDebug("WORLD: HandleGossipHelloOpcode - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleGossipSelectOptionOpcode(WorldPacket& recv_data)
{
    ...
    {
        recv_data >> code;
        sLog.outDebug("Gossip code: %s", code.c_str());
    }
...
void WorldSession::HandleSpiritHealerActivateOpcode(WorldPacket& recv_data)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: HandleSpiritHealerActivateOpcode - %s not found or you can't interact with him.", guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleBinderActivateOpcode(WorldPacket& recv_data)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: HandleBinderActivateOpcode - %s not found or you can't interact with him.", npcGuid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleListStabledPetsOpcode(WorldPacket& recv_data)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: HandleListStabledPetsOpcode - %s not found or you can't interact with him.", npcGUID.GetString().c_str());
        return;
    }
...
bool WorldSession::CheckStableMaster(ObjectGuid guid)
{
    ...
    if (guid == GetPlayer()->GetObjectGuid())
    {
        ...
        {
            sLog.outDebug("%s attempt open stable in cheating way.", guid.GetString().c_str());
            return false;
        }
    }
    // stable master case
    else
    {
        ...
        {
            sLog.outDebug("Stablemaster %s not found or you can't interact with him.", guid.GetString().c_str());
            return false;
        }
    }
...
void WorldSession::HandleRepairItemOpcode(WorldPacket& recv_data)
{
    ...
    if (!unit)
    {
        sLog.outDebug("WORLD: HandleRepairItemOpcode - %s not found or you can't interact with him.", npcGuid.GetString().c_str());
        return;
    }
    ...
    if (itemGuid)
    {
        sLog.outDebug("ITEM: %s repair of %s", npcGuid.GetString().c_str(), itemGuid.GetString().c_str());
    ...
    {
        sLog.outDebug("ITEM: %s repair all items", npcGuid.GetString().c_str());
