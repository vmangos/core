enum OpcodesList
{
    ...
    SMSG_WEATHER                               = 758,
    SMSG_PLAY_TIME_WARNING                     = 759,
    SMSG_MINIGAME_SETUP                        = 760,
    SMSG_MINIGAME_STATE                        = 761,
    CMSG_MINIGAME_MOVE                         = 762,
    SMSG_MINIGAME_MOVE_FAILED                  = 763,
    SMSG_RAID_INSTANCE_MESSAGE                 = 764,
    SMSG_COMPRESSED_MOVES                      = 765,
    NUM_MSG_TYPES                              = 766
};
