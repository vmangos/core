...
bool Group::Create(ObjectGuid guid, char const*  name)
{
    ...
    if (!isBGGroup())
    {
        ...
        CharacterDatabase.PExecute("REPLACE `groups` (`group_id`, `leader_guid`, `main_tank_guid`, `main_assistant_guid`, `loot_method`, `looter_guid`, `loot_threshold`, `icon1`, `icon2`, `icon3`, `icon4`, `icon5`, `icon6`, `icon7`, `icon8`, `is_raid`) "
