...
#define OUT_LOAD_INST_DATA_FAIL        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: Unable to load Instance Data for Instance %s (Map %d, Instance Id: %d).",instance->GetMapName(), instance->GetId(), instance->GetInstanceId())
