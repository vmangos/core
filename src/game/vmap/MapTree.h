...
namespace VMAP
{
    ...
    class StaticMapTree
    {
        ...
        private:
            bool getIntersectionTime(G3D::Ray const& pRay, float& pMaxDist, bool pStopAtFirstHit, bool isLosCheck, bool forceM2ObjectLos) const;
        ...
        public:
            ...
            bool isInLineOfSight(G3D::Vector3 const& pos1, G3D::Vector3 const& pos2, bool forceM2ObjectLos) const;
            ModelInstance* FindCollisionModel(G3D::Vector3 const& pos1, G3D::Vector3 const& pos2);
            bool getObjectHitPos(G3D::Vector3 const& pos1, G3D::Vector3 const& pos2, G3D::Vector3& pResultHitPos, float pModifyDist, bool forceM2ObjectLos) const;
            float getHeight(G3D::Vector3 const& pPos, float maxSearchDist, bool forceM2ObjectLos) const;
