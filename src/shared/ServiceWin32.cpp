...
bool WinServiceInstall()
{
    ...
    {
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: SERVICE: No access to service control manager.");
        return false;
    }
    ...
    if (!GetModuleFileName(0, path, sizeof(path)/sizeof(path[0])))
    {
        ...
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: SERVICE: Can't get service binary filename.");
        return false;
    }
    ...
    {
        CloseServiceHandle(serviceControlManager);
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: SERVICE: Can't register service for: %s", path);
        return false;
    }
    ...
    if(!advapi32)
    {
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: SERVICE: Can't access ADVAPI32.DLL");
    ...
    {
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: SERVICE: Can't access ChangeServiceConfig2A from ADVAPI32.DLL");
        CloseServiceHandle(service);
        CloseServiceHandle(serviceControlManager);
        return false;
    }
...
bool WinServiceUninstall()
{
    ...
    {
        CloseServiceHandle(serviceControlManager);
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: SERVICE: Service not found: %s", serviceName);
        return false;
    }
...
bool WinServiceRun()
{
    ...
    {
        sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: StartService Failed. Error [%u]", ::GetLastError());
        return false;
    }
    return true;
}
