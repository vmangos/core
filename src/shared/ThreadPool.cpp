...
void ThreadPool::worker::loop_wrapper()
{
    ...
    else
    {
        ...
        {
            sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: A ThreadPool task generated an exception: %s",e.what());
        }
        catch (const std::string &e)
        {
            sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: A ThreadPool task generated an exception: %s", e.c_str());
        }
        catch (...)
        {
            sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: A ThreadPool task generated an exception");
        }
