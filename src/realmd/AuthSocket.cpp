...
enum AccountFlags
{
    ...
    ACCOUNT_FLAG_EUFORBIDELV         = 0x00000100,
    ACCOUNT_FLAG_EUFORBIDBILLING     = 0x00000200,
    ACCOUNT_FLAG_WOWRESTRICTED       = 0x00000400,
    ACCOUNT_FLAG_PARENTALCONTROL     = 0x00000800,
    ACCOUNT_FLAG_REFERRAL            = 0x00001000,
    ACCOUNT_FLAG_BLIZZARD            = 0x00002000,
    ACCOUNT_FLAG_RECURRINGBILLING    = 0x00004000,
    ACCOUNT_FLAG_NOELECTUP           = 0x00008000,
    ACCOUNT_FLAG_KRCERTIFICATE       = 0x00010000,
    ACCOUNT_FLAG_EXPANSIONCOLLECTOR  = 0x00020000,
    ACCOUNT_FLAG_DISABLEVOICE        = 0x00040000,
    ACCOUNT_FLAG_DISABLEVOICESPEAK   = 0x00080000,
    ACCOUNT_FLAG_REFERRALRESURRECT   = 0x00100000,
    ACCOUNT_FLAG_EUFORBIDCC          = 0x00200000,
    ACCOUNT_FLAG_OPENBETADELL        = 0x00400000,
    ACCOUNT_FLAG_PROPASS             = 0x00800000,
    ACCOUNT_FLAG_PROPASSLOCK         = 0x01000000,
    ACCOUNT_FLAG_PENDINGUPGRADE      = 0x02000000,
    ACCOUNT_FLAG_RETAILFROMTRIAL     = 0x04000000,
    ACCOUNT_FLAG_EXPANSION2COLLECTOR = 0x08000000,
    ACCOUNT_FLAG_OVERMINDLINKED      = 0x10000000,
