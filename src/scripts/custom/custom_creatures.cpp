...
bool GossipHello_TeleportNPC(Player* player, Creature* _Creature)
{
	...
	//sprintf(tmp, "|cFF0041FF我的帐户积分：[%d]点|r 　", player->Getjifen());
	...
	if (player->GetTeam() == HORDE)
	{
		...
		player->ADD_GOSSIP_ITEM(5, "初始之地", GOSSIP_SENDER_MAIN, 3);
		player->ADD_GOSSIP_ITEM(5, "五人副本", GOSSIP_SENDER_MAIN, 5);
		player->ADD_GOSSIP_ITEM(5, "团队副本", GOSSIP_SENDER_MAIN, 101);
		player->ADD_GOSSIP_ITEM(5, "战争召唤", GOSSIP_SENDER_MAIN, 10);
		player->ADD_GOSSIP_ITEM(5, "野外BOSS", GOSSIP_SENDER_MAIN, 6000);
		player->ADD_GOSSIP_ITEM(5, "卡利姆多", GOSSIP_SENDER_MAIN, 6010);
		player->ADD_GOSSIP_ITEM(5, "东部王国", GOSSIP_SENDER_MAIN, 6020);
		player->ADD_GOSSIP_ITEM(5, "特殊地区", GOSSIP_SENDER_MAIN, 6030);
	...
	else
	{
		...
		player->ADD_GOSSIP_ITEM(5, "初始之地", GOSSIP_SENDER_MAIN, 4);
		player->ADD_GOSSIP_ITEM(5, "五人副本", GOSSIP_SENDER_MAIN, 5);
		player->ADD_GOSSIP_ITEM(5, "团队副本", GOSSIP_SENDER_MAIN, 101);
		player->ADD_GOSSIP_ITEM(5, "战争召唤", GOSSIP_SENDER_MAIN, 11);
		player->ADD_GOSSIP_ITEM(5, "野外BOSS", GOSSIP_SENDER_MAIN, 6000);
		player->ADD_GOSSIP_ITEM(5, "卡利姆多", GOSSIP_SENDER_MAIN, 6010);
		player->ADD_GOSSIP_ITEM(5, "东部王国", GOSSIP_SENDER_MAIN, 6020);
		player->ADD_GOSSIP_ITEM(5, "特殊地区", GOSSIP_SENDER_MAIN, 6030);
...
void SendDefaultMenu_TeleportNPC(Player* player, Creature* _Creature, uint32 action)
{
	...
	case 1: // Cities [HORDE]
		...
		player->ADD_GOSSIP_ITEM(5, "加基森", GOSSIP_SENDER_MAIN, 609);
	...
	case 4: // Starting Places [ALLIANCE]
		...
		break;
	case 10: // 部落战场
		player->ADD_GOSSIP_ITEM(5, "战歌峡谷", GOSSIP_SENDER_MAIN, 140);
		player->ADD_GOSSIP_ITEM(5, "阿拉希盆地", GOSSIP_SENDER_MAIN, 141);
		player->ADD_GOSSIP_ITEM(5, "奥特兰克山谷", GOSSIP_SENDER_MAIN, 142);
		...
		break;
	case 11: // 联盟战场
		player->ADD_GOSSIP_ITEM(5, "战歌峡谷", GOSSIP_SENDER_MAIN, 143);
		player->ADD_GOSSIP_ITEM(5, "阿拉希盆地", GOSSIP_SENDER_MAIN, 144);
		player->ADD_GOSSIP_ITEM(5, "奥特兰克山谷", GOSSIP_SENDER_MAIN, 145);
		player->ADD_GOSSIP_ITEM(5, "古拉巴什竞技场", GOSSIP_SENDER_MAIN, 4015);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);
	...
	case 5: // Instances [PAGE 1]
		...
		player->ADD_GOSSIP_ITEM(5, "暴风监狱", GOSSIP_SENDER_MAIN, 1267);
		player->ADD_GOSSIP_ITEM(5, "怒焰裂谷", GOSSIP_SENDER_MAIN, 1269);
	...
	case 5551: // Instances [PAGE 2]
		player->ADD_GOSSIP_ITEM(5, "诺莫瑞根", GOSSIP_SENDER_MAIN, 1268);
	...
	case 101: // Raids
		...
		break;
	case 6000: // boss
		player->ADD_GOSSIP_ITEM(5, "暮色森林-艾莫莉丝", GOSSIP_SENDER_MAIN, 5000);
		player->ADD_GOSSIP_ITEM(5, "辛特兰-伊索德雷", GOSSIP_SENDER_MAIN, 5001);
		player->ADD_GOSSIP_ITEM(5, "灰谷-泰拉尔", GOSSIP_SENDER_MAIN, 5002);
		player->ADD_GOSSIP_ITEM(5, "艾萨拉—艾索雷葛斯", GOSSIP_SENDER_MAIN, 5003);
		player->ADD_GOSSIP_ITEM(5, "菲拉斯-莱索恩", GOSSIP_SENDER_MAIN, 5004);
		player->ADD_GOSSIP_ITEM(5, "诅咒之地-卡扎克", GOSSIP_SENDER_MAIN, 5005);
		player->ADD_GOSSIP_ITEM(5, "希利苏斯-风元素", GOSSIP_SENDER_MAIN, 5006);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);
	...
	case 6010: // Kalimdor [PAGE 1]
		...
		player->ADD_GOSSIP_ITEM(5, "永望镇", GOSSIP_SENDER_MAIN, 612);
		player->ADD_GOSSIP_ITEM(7, "[下一页]->", GOSSIP_SENDER_MAIN, 6011);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);

		player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, _Creature->GetGUID());
		break;
	case 6011: // Kalimdor [PAGE 2]
		player->ADD_GOSSIP_ITEM(5, "棘齿城", GOSSIP_SENDER_MAIN, 628);
		player->ADD_GOSSIP_ITEM(5, "艾萨拉", GOSSIP_SENDER_MAIN, 631);
		player->ADD_GOSSIP_ITEM(5, "安戈烙环形山", GOSSIP_SENDER_MAIN, 632);
		player->ADD_GOSSIP_ITEM(7, "<-[上一页]", GOSSIP_SENDER_MAIN, 6010);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);
	...
	case 6020: // Eastern Kingdoms [PAGE 1]
		...
		player->ADD_GOSSIP_ITEM(5, "闪金镇", GOSSIP_SENDER_MAIN, 618);
		...
		player->ADD_GOSSIP_ITEM(5, "荆棘谷/祖格岛", GOSSIP_SENDER_MAIN, 622);
		...
		player->ADD_GOSSIP_ITEM(7, "[下一页]->", GOSSIP_SENDER_MAIN, 6021);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);

		player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, _Creature->GetGUID());
		break;
	case 6021: // 东部王国 [PAGE 2]
		player->ADD_GOSSIP_ITEM(5, "哨兵岭", GOSSIP_SENDER_MAIN, 626);
		player->ADD_GOSSIP_ITEM(5, "湿地", GOSSIP_SENDER_MAIN, 627);
		player->ADD_GOSSIP_ITEM(5, "藏宝海湾", GOSSIP_SENDER_MAIN, 629);
		player->ADD_GOSSIP_ITEM(5, "东谷伐木场", GOSSIP_SENDER_MAIN, 630);
		player->ADD_GOSSIP_ITEM(7, "<-[上一页]", GOSSIP_SENDER_MAIN, 6020);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);

		player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, _Creature->GetGUID());
		break;
	case 6030: // 观光地
		player->ADD_GOSSIP_ITEM(5, "卡拉赞副本后门", GOSSIP_SENDER_MAIN, 700);
		player->ADD_GOSSIP_ITEM(5, "千针石林最高峰", GOSSIP_SENDER_MAIN, 701);
		player->ADD_GOSSIP_ITEM(5, "地铁海底水族馆", GOSSIP_SENDER_MAIN, 702);
		player->ADD_GOSSIP_ITEM(5, "铁炉堡后山山顶", GOSSIP_SENDER_MAIN, 703);
		player->ADD_GOSSIP_ITEM(5, "海加尔山观光地", GOSSIP_SENDER_MAIN, 704);
		player->ADD_GOSSIP_ITEM(5, "旧南海镇没有怪", GOSSIP_SENDER_MAIN, 705);
		//player->ADD_GOSSIP_ITEM(5, "翡翠森林一片绿", GOSSIP_SENDER_MAIN, 706);
		player->ADD_GOSSIP_ITEM(5, "传说中的 GM 岛", GOSSIP_SENDER_MAIN, 707);
		player->ADD_GOSSIP_ITEM(5, "<-[主菜单]", GOSSIP_SENDER_MAIN, 100);
	...
	case 1266://teleport player to Scholomance
		...
		break;
	case 1267://teleport player to 暴风城监狱
		player->CLOSE_GOSSIP_MENU();
		player->TeleportTo(34, 54.23f, 0.28f, -18.02f, 0.00f);
		break;
	case 1268://teleport player to 诺莫瑞根
		player->CLOSE_GOSSIP_MENU();
		player->TeleportTo(90, -332.03f, -2.20f, -151.01f, 0.00f);
		break;
	case 1269://teleport player to 怒焰裂谷
		player->CLOSE_GOSSIP_MENU();
	...
	case 4006:// Naxxramas
		...
		break;
	case 4007://teleport player to 冰龙巢穴 
		player->CLOSE_GOSSIP_MENU();
...
void Enchant(Player* player, Item* item, uint32 enchantid)
{
	if (!item)
	{
		player->GetSession()->SendNotification("你必须先装备需要附魔的物品.");
		return;
	}

	if (!enchantid)
	{
		player->GetSession()->SendNotification("出了点问题.");
		return;
	}

	item->ClearEnchantment(PERM_ENCHANTMENT_SLOT);
	item->SetEnchantment(PERM_ENCHANTMENT_SLOT, enchantid, 0, 0);
	player->GetSession()->SendNotification("|cff4CFF00您的|cffDA70D6%s已附魔成功", item->GetProto()->Name1);
}
...
bool GossipHello_EnchantNPC(Player* player, Creature* creature)
{
	...
	player->ADD_GOSSIP_ITEM(5, "护手", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_HANDS);
	player->ADD_GOSSIP_ITEM(5, "靴子", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_FEET);
	player->ADD_GOSSIP_ITEM(5, "武器", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_MAINHAND);
	player->ADD_GOSSIP_ITEM(5, "盾牌", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_OFFHAND);
...
bool GossipSelect_EnchantNPC(Player* player, Creature* creature, uint32 sender, uint32 action)
{
	...
	if (action < 20)
	{
		...
		case EQUIPMENT_SLOT_FEET:
			...
			player->ADD_GOSSIP_ITEM(5, "移动速度", GOSSIP_SENDER_MAIN, BOOTS_SPEED);
		...
		case EQUIPMENT_SLOT_MAINHAND:
			...
			player->ADD_GOSSIP_ITEM(5, "15敏捷", GOSSIP_SENDER_MAIN, WEP1H_AGILITY);
			player->ADD_GOSSIP_ITEM(5, "25敏捷", GOSSIP_SENDER_MAIN, WEP2H_AGILITY);
	...
	else
	{
		...
		case WEP2H_AGILITY:
			...
			if (item && (action == WEP2H_AGILITY || action == WEP2H_SUPERIOR_IMPACT))
			{
				...
				{
					player->GetSession()->SendNotification("需要先装备双手武器");
					player->CLOSE_GOSSIP_MENU();
					return true;
				}
			}
		...
		case OFFHAND_FROSTRES:
			...
			{
				player->GetSession()->SendNotification("你需要先装备盾牌");
				player->CLOSE_GOSSIP_MENU();
				return true;
			}
...
void EnchantCZ(Player* player, Item* item, uint32 enchantid)
{
	...
	{
		//player->GetSession()->SendNotification("你必须先装备需要附魔的物品.");
		player->GetSession()->SendNotification("你必须先装备需要洗练的物品.");
	...
	if (player->HasItemCount(42053,1))
	{
		...
		//
		player->GetSession()->SendNotification("|cff4CFF00您的|cffDA70D6%s已洗练成功,请看包裹!", item->GetProto()->Name1);
		player->CLOSE_GOSSIP_MENU();
	...
	else
	{
		...
		player->GetSession()->SendNotification("|cff4CFF00您的|原始宝石不够.");
		player->CLOSE_GOSSIP_MENU();
...
{
	//	char* tmp = new char[100];
	//sprintf(tmp, "|cFF0041FF重置注意!以下选择重置玩家装备栏中对应的装备,不可撤销,请注意!|r ", 0);
	player->ADD_GOSSIP_ITEM(4, "|cFF0041FF重置注意!以下选择重置玩家装备栏中对应的装备,不可撤销,请注意|r", GOSSIP_SENDER_MAIN, 0);

	player->ADD_GOSSIP_ITEM(5, "重置胸甲-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_CHEST);
	player->ADD_GOSSIP_ITEM(5, "重置披风-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_BACK);
	player->ADD_GOSSIP_ITEM(5, "重置护腕-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_WRISTS);
	player->ADD_GOSSIP_ITEM(5, "重置护手-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_HANDS);
	player->ADD_GOSSIP_ITEM(5, "重置靴子-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_FEET);
	player->ADD_GOSSIP_ITEM(5, "重置武器-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_MAINHAND);
	player->ADD_GOSSIP_ITEM(5, "重置副手-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_OFFHAND);
	player->ADD_GOSSIP_ITEM(5, "重置远程武器槽-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_RANGED);
...
bool GossipSelect_EnchantCZNPC(Player* player, Creature* creature, uint32 sender, uint32 action)
{
	...
	if (action < 20)
	{
		...
		{
		case EQUIPMENT_SLOT_CHEST:
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, CHEST_STATS);
			break;
		case EQUIPMENT_SLOT_BACK:
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, CLOAK_AGILITY);
			//player->ADD_GOSSIP_ITEM(5, "护甲+70", GOSSIP_SENDER_MAIN, CLOAK_ARMOR);
			//player->ADD_GOSSIP_ITEM(5, "躲闪+1%", GOSSIP_SENDER_MAIN, CLOAK_DODGE);
			//player->ADD_GOSSIP_ITEM(5, "狡诈", GOSSIP_SENDER_MAIN, CLOAK_SUB);
			break;
		case EQUIPMENT_SLOT_WRISTS:
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, BRACER_STAM);
			//player->ADD_GOSSIP_ITEM(5, "力量+9", GOSSIP_SENDER_MAIN, BRACER_STR);
			//player->ADD_GOSSIP_ITEM(5, "治疗法术+24", GOSSIP_SENDER_MAIN, BRACER_HEAL);
			//player->ADD_GOSSIP_ITEM(5, "智力+7", GOSSIP_SENDER_MAIN, BRACER_INT);
			break;
		case EQUIPMENT_SLOT_HANDS:
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, GLOVES_AGI);
			//player->ADD_GOSSIP_ITEM(5, "火焰伤害+20", GOSSIP_SENDER_MAIN, GLOVES_FIRE);
			//player->ADD_GOSSIP_ITEM(5, "冰霜伤害+20", GOSSIP_SENDER_MAIN, GLOVES_FROST);
			//player->ADD_GOSSIP_ITEM(5, "暗影伤害+20", GOSSIP_SENDER_MAIN, GLOVES_SHADOW);
			//player->ADD_GOSSIP_ITEM(5, "治疗法术+30", GOSSIP_SENDER_MAIN, GLOVES_HEALING);
			break;
		case EQUIPMENT_SLOT_FEET:
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, BOOTS_STAM);
			//player->ADD_GOSSIP_ITEM(5, "移动速度", GOSSIP_SENDER_MAIN, BOOTS_SPEED);
			//player->ADD_GOSSIP_ITEM(5, "敏捷+5", GOSSIP_SENDER_MAIN, BOOTS_AGI);
			break;
		case EQUIPMENT_SLOT_MAINHAND:
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, WEP_CRUSADER);
			//player->ADD_GOSSIP_ITEM(5, "15敏捷", GOSSIP_SENDER_MAIN, WEP1H_AGILITY);
			//player->ADD_GOSSIP_ITEM(5, "25敏捷", GOSSIP_SENDER_MAIN, WEP2H_AGILITY);
			//player->ADD_GOSSIP_ITEM(5, "法术伤害+30", GOSSIP_SENDER_MAIN, WEP_SPELLPOWER);
			//player->ADD_GOSSIP_ITEM(5, "治疗法术+55", GOSSIP_SENDER_MAIN, WEP_HEAL);
			break;
		case EQUIPMENT_SLOT_OFFHAND:
			//player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, OFFHAND_SPIRIT);
			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, OFFHAND_STAM);
			//player->ADD_GOSSIP_ITEM(5, "冰霜抗性+8", GOSSIP_SENDER_MAIN, OFFHAND_FROSTRES);
			break;

		case  EQUIPMENT_SLOT_RANGED:

			player->ADD_GOSSIP_ITEM(5, "请确认! 装备栏中物品将重置", GOSSIP_SENDER_MAIN, WEP_RANGE);
...
bool LearnAllRecipesInProfession(Player* pPlayer, SkillType skill)
{
	...
	pPlayer->GetSession()->SendNotification("|cff4CFF00您已经已学会了|cffDA70D6%s全部技能", skill_name);
	return true;
}
...
bool GossipHello_ProfessionNPC(Player* player, Creature* creature)
{
	...
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "炼金-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 1);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "锻造-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 2);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "制皮-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 3);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "裁缝-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 4);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "工程-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 5);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "附魔-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 6);
	//player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "珠宝加工" , GOSSIP_SENDER_MAIN, 7);
	//player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "铭文" , GOSSIP_SENDER_MAIN, 8);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "草药-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 9);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "剥皮-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 10);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "采矿-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 11);

	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "急救-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 12);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "钓鱼-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 13);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "烹饪-> 消耗5个原始宝石", GOSSIP_SENDER_MAIN, 14);;
...
void CompleteLearnProfession(Player* pPlayer, Creature* pCreature, SkillType skill)
{
	...
	{
		pPlayer->GetSession()->SendNotification("你已经学会了两个专业技能.");
	}
	else
	{
		if (!LearnAllRecipesInProfession(pPlayer, skill))
			pPlayer->GetSession()->SendNotification("未知错误.");
	}
}
...
bool GossipHello_RaLNPC(Player* player, Creature* creature)
{
	...
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "重置所有团本 -> 需要2个原始宝石", GOSSIP_SENDER_MAIN, 1);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "直升60级     -> 需要5个原始宝石", GOSSIP_SENDER_MAIN, 2);
	player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "积分兑换     -> 比例1 : 100G   ", GOSSIP_SENDER_MAIN, 3);
	//player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "领取工资     -> 按在线时间兑换 ", GOSSIP_SENDER_MAIN, 4);
...
bool GossipSelect_RaLNPC(Player* player, Creature* creature, uint32 sender, uint32 action)
{
	...
	case 1:
		...
		if (player->HasItemCount(42053, 1)) // 修改一下152，修改成你需要设置消耗的物品ID
		{
			...
			player->GetSession()->SendNotification("副本已经重置，需要重新登录游戏才生效!");
		...
		{
			player->GetSession()->SendNotification("你至少需要2个原始宝石！");
			player->PlayerTalkClass->CloseGossip();
		}
	...
	case 2:
		...
		{ 
		  ...
		  {
			player->GetSession()->SendNotification("你不能再提高等级了");
			return false;
		   }
		else
		   {
			...
			player->DestroyItemCount(42053, 5, true, false);
			player->GetSession()->SendNotification("提升等级成功");
			return true;
		    }
		}
		else
		{
			player->GetSession()->SendNotification("你至少需要5个原始宝石！");
			player->PlayerTalkClass->CloseGossip();
		}
	...
	case 3:
		...
		if (JF > 0)
		{
			...
			player->GetSession()->SendNotification("|cffFFFF00WOW 物品已经发送,请查看包裹!");
		...
		else
		{
			...
			player->GetSession()->SendNotification("|cffFFFF00WOW 积分不足! 系统不给白嫖");
			return 0;
		}
		break;
	case 4:
...
//	//player->ADD_GOSSIP_ITEM(5, "护手", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_HANDS);
//	//player->ADD_GOSSIP_ITEM(5, "靴子", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_FEET);
//	player->ADD_GOSSIP_ITEM(5, "重置主手装备-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_MAINHAND);
//	player->ADD_GOSSIP_ITEM(5, "重置副手装备-> 消耗1原始宝石", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_OFFHAND);
//
//	player->SEND_GOSSIP_MENU(player->GetGossipTextId(creature), creature->GetGUID());
//	return true;
//}
