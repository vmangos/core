            ...
            switch (eyeStalk.currentState)
            {
                case EyeStalkInfo::COOLDOWN:
                {
                    ...
                    if (eyeStalk.timer < diff)
                    {
                        ...
                        {
                            sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: boss_loatheb.cpp - availableEyeLocs size 0, should not happen!");
                            return;
                        }
                        ...
                        if (!pStalk)
                        {
                            sLog.Out(LOG_BASIC, LOG_LVL_MINIMAL, "ERROR: Heigans WhackAStalk failed to summon eye stalk");
                            return;
                        }
