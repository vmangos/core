...
//#endif
    ...
    GAME_EVENT_SCOURGE_INVASION_BURNING_STEPPES_EVENT   = 95,
};
...
enum ScourgeInvasionWorldStatesVariables
{
    ...
    VARIABLE_SI_WINTERSPRING_REMAINING          = 618,
    VARIABLE_SI_AZSHARA_REMAINING               = 16,
    VARIABLE_SI_EASTERN_PLAGUELANDS_REMAINING   = 139,
    VARIABLE_SI_BLASTED_LANDS_REMAINING         = 4,
    VARIABLE_SI_BURNING_STEPPES_REMAINING       = 46,
    VARIABLE_SI_TANARIS_REMAINING               = 440,
};
