...
-- Add gossip and quest to Argent Outfitter and argent quartermaster
UPDATE `creature_template` SET `npcflag`=3, `gossip_menu_id`=50000 WHERE `entry` in (16786,16787);
