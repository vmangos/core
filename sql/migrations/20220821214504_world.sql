...
(@OGUID+10, 1667, 0, -3870.253173828125, -2383.634033203125, 26.57918357849121093, 0.174532130360603332, 0, 0, 0.087155342102050781, 0.996194720268249511, 300, 300, 100, 1, 0, 0, 0, 10),
(@OGUID+11, 1667, 0, -3929.862548828125, -2318.629882812500, 23.00192070007324218, 5.934120178222656250, 0, 0, -0.17364788055419921, 0.984807789325714111, 300, 300, 100, 1, 0, 0, 0, 10),
(@OGUID+12, 1667, 0, -3799.523925781250, -2390.446533203125, 28.52526473999023437, 2.670347690582275390, 0, 0, 0.972369194030761718, 0.233448356389999389, 300, 300, 100, 1, 0, 0, 0, 10),
(@OGUID+13, 1667, 0, -3785.216064453125, -2375.884033203125, 30.60120010375976562, 3.316144466400146484, 0, 0, -0.99619388580322265, 0.087165042757987976, 300, 300, 100, 1, 0, 0, 0, 10),
(@OGUID+14, 1667, 0, -3833.576904296875, -2299.875976562500, 30.47358512878417968, 4.468043327331542968, 0, 0, -0.78801059722900390, 0.615661680698394775, 300, 300, 100, 1, 0, 0, 0, 10);
...
(@OGUID+7, @PTEMPLATE+1, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+8, @PTEMPLATE+2, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+9, @PTEMPLATE+3, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+10, @PTEMPLATE+4, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+11, @PTEMPLATE+5, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+12, @PTEMPLATE+6, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+13, @PTEMPLATE+1, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+14, @PTEMPLATE+2, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+15, @PTEMPLATE+3, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+16, @PTEMPLATE+4, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+17, @PTEMPLATE+5, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+18, @PTEMPLATE+6, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+19, @PTEMPLATE+1, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+20, @PTEMPLATE+2, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+21, @PTEMPLATE+3, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+22, @PTEMPLATE+4, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+23, @PTEMPLATE+5, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+24, @PTEMPLATE+6, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+25, @PTEMPLATE+1, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+26, @PTEMPLATE+2, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+27, @PTEMPLATE+3, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+28, @PTEMPLATE+4, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+29, @PTEMPLATE+5, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10),
(@OGUID+30, @PTEMPLATE+6, 'Mithril Deposit / Truesilver Deposit - Arathi Highlands', 10);
