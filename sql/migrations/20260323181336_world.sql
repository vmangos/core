...
(@PTEMPLATE+1, 1, 'Hinterlands - Group 1 - Truesilver Deposit / Small Thorium Vein', 0, 0, 0, 10);
...
INSERT INTO `pool_template` (`entry`, `max_limit`, `description`, `flags`, `instance`, `patch_min`, `patch_max`) VALUES
(@PTEMPLATE+2, 1, 'Hinterlands - Group 2 - Truesilver Deposit / Small Thorium Vein', 0, 0, 0, 10);
INSERT INTO `pool_pool` (`pool_id`, `mother_pool`, `chance`, `description`, `flags`) VALUES
...
INSERT INTO `pool_template` (`entry`, `max_limit`, `description`, `flags`, `instance`, `patch_min`, `patch_max`) VALUES
(@PTEMPLATE+3, 1, 'Hinterlands - Group 3 - Truesilver Deposit / Small Thorium Vein', 0, 0, 0, 10);
INSERT INTO `pool_pool` (`pool_id`, `mother_pool`, `chance`, `description`, `flags`) VALUES
