...
UPDATE `spell_template` SET `script_name`='spell_deviat_fish' WHERE `entry`= 8063;
UPDATE `spell_template` SET `script_name`='spell_cooked_deviat_fish' WHERE `entry`= 8213;
