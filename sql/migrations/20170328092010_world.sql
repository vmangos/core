...
UPDATE `world`.`quest_template` SET `RequestItemsText` = "Hmm... You come with the spirit of the forest strongly within you, $C. What business do you have with the Arch Druid of the Kaldorei?" WHERE `entry` = 940;

-- Grove of the Ancients: Fandral Staghelm should be referred as Arch Druid, not Arch $C
UPDATE `world`.`quest_template` SET `OfferRewardText` = "Ah. Thank you, $N. It is strange, though. The Arch Druid always seems in such a hurry. The forest knows that all shall come to pass in the appointed time. Shan'do Stormrage understood that." where `entry` = 952;
...
UPDATE `world`.`quest_template` SET `OfferRewardText`="Shan'do Stormrage never returned, and the druids were in disarray, and to this day we still do not know what became of him. With Malfurion missing, Arch Druid Fandral Staghelm took over the leadership of the druids, convincing the Circle of Ancients in Darkshore that it was time for our people to rebuild, and that it was time for our people to regain their immortality.$B$BWith the approval of the Circle, Staghelm and the most powerful druids grew Teldrassil, the new World Tree." WHERE `entry`=933;
UPDATE `world`.`quest_template` SET 
