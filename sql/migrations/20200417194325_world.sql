...
-- update Desperate Prayer (5637) to Maxan Anvol (1226)
UPDATE `creature_questrelation` SET `id` = 1226 WHERE `quest` = 5637;

-- update Desperate Prayer (5640) to Priestess Alathea (11401)
UPDATE `creature_questrelation` SET `id` = 11401 WHERE `quest` = 5640;
...
UPDATE `quest_template` SET `OfferRewardText` = "I'm glad you've arrived, $n. There are many things we will have to discuss, but more importantly is your training in the ways of the Light.$b$bThere are lessons all servants of the Light must learn. If you are ready, we'll begin discussing some of those now." WHERE `entry` = (5677);
...
-- update Returning Home (5630) to Maxan Anvol (1266)
UPDATE `creature_questrelation` SET `id` = 1266 WHERE `quest` = 5630;

-- update Returning Home (5632) to Nara Meideros (11397)
UPDATE `creature_questrelation` SET `id` = 11397 WHERE `quest` = 5632;

-- update Returning Home (5633) to Braenna Flintcrag (5142)
UPDATE `creature_questrelation` SET `id` = 5142 WHERE `quest` = 5633;
...
-- remove quest A Lack of Fear (5645) from Toldren Deepiron (5143)
DELETE FROM `creature_questrelation` WHERE `quest` = 5645 AND `id` = 5143;
