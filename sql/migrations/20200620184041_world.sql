...
UPDATE `quest_template` SET  `OfferRewardText`='Step through the opening to my right and you shall find yourself inside the Molten Core.' WHERE `entry`=7487; 
UPDATE `quest_template` SET  `RequestItemsText`='Jumping through the opening now could end in disaster... for you.' WHERE `entry`=7487; 
