...
SET v = (SELECT COUNT(*) FROM `migrations` WHERE `id`='202505090000');
IF v = 0 THEN
INSERT INTO `migrations` VALUES ('202505090000');
-- Add your query below.

-- Source: mod-playerbots-wotlk/data/sql/playerbots/updates/2025_05_09_00.sql
