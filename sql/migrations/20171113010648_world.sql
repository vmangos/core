...
REPLACE INTO `db_script_string` (`entry`, `content_default`) VALUES (2000008739, 'Quickly, bring my report to Cenarion Hold!');
...
REPLACE INTO `gossip_scripts` (`id`, `dataint`, `comments`) VALUES (15611, 2000008739, 'Hive\'Ashi Scout Report completion text');
...
REPLACE INTO `gossip_scripts` (`id`, `dataint`, `comments`) VALUES (15609, 2000008739, 'Hive\'Regal Scout Report completion text');
REPLACE INTO `gossip_menu_option` (`menu_id`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_script_id`, `condition_id`) 
...
REPLACE INTO `gossip_scripts` (`id`, `dataint`, `comments`) VALUES (15610, 2000008739, 'Hive\'Zora Scout Report completion text');
REPLACE INTO `gossip_menu_option` (`menu_id`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_script_id`, `condition_id`) 
