...
INSERT INTO `gossip_menu` (`entry`, `text_id`, `script_id`, `condition_id`) VALUES (1964, 1, 0, 0);
...
INSERT INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_broadcast_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `action_script_id`, `box_coded`, `box_money`, `box_text`, `box_broadcast_text`, `condition_id`) VALUES (1964, 2855, 0, 'Hey Jangdor - can you teach me again how to make Wild Leather Shoulders again?', 9839, 0, 7, -1, 0, 2855, 0, 0, 0, 0, 20017);
...
--(1964, 2856, 0, 'Hey Jangdor - can you teach me again how to make a Wild Leather Vest again?', 9840, 0, 7, -1, 0, 2856, 0, 0, 0, 0, 20018);
