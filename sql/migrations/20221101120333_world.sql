...
(20000, 8, 2855, 0, 0, 0, 0), -- Condition to return true if 2855 (Wild Leather Shoulders (horde side)) is complete
(20001, 8, 2856, 0, 0, 0, 0), -- Condition to return true if 2856 (Wild Leather Vest (horde side)) is complete
(20002, 8, 2857, 0, 0, 0, 0), -- Condition to return true if 2857 (Wild Leather Helmet (horde side)) is complete
(20003, -1, 20000, 20001, 20002, 0, 0), -- Condition to return true if the previous 3 conditions are true
(20004, 8, 2848, 0, 0, 0, 0), -- Condition to return true if 2848 (Wild Leather Shoulders (alliance side)) is complete
(20005, 8, 2849, 0, 0, 0, 0), -- Condition to return true if 2849 (Wild Leather Vest (alliance side)) is complete
(20006, 8, 2850, 0, 0, 0, 0), -- Condition to return true if 2850 (Wild Leather Helmet (alliance side)) is complete
(20007, -1, 20004, 20005, 20006, 0, 0), -- Condition to return true if the previous 3 conditions are true
(20008, 17, 10529, 1, 0, 0, 0), -- Condition to return true if Pattern: Wild Leather Shoulders is NOT learnt
(20009, 17, 10544, 1, 0, 0, 0), -- Condition to return true if Pattern: Wild Leather Vest is NOT learnt
(20010, 17, 10546, 1, 0, 0, 0), -- Condition to return true if Pattern: Wild Leather Helmet is NOT learnt
(20011, 17, 10566, 1, 0, 0, 0), -- Condition to return true if Pattern: Wild Leather Boots is NOT learnt
(20012, 17, 10572, 1, 0, 0, 0), -- Condition to return true if Pattern: Wild Leather Leggings is NOT learnt
(20027, 17, 10574, 1, 0, 0, 0), -- Condition to return true if Pattern: Wild Leather Cloak is NOT learnt
(20013, 8, 2858, 0, 0, 0, 0), -- Condition to return true if 2858 (Wild Leather Boots (horde side)) is complete
(20014, 8, 2859, 0, 0, 0, 0), -- Condition to return true if 2859 (Wild Leather Leggings (horde side)) is complete
(20015, 8, 2851, 0, 0, 0, 0), -- Condition to return true if 2851 (Wild Leather Boots (alliance side)) is complete
(20016, 8, 2852, 0, 0, 0, 0), -- Condition to return true if 2852 (Wild Leather Leggings (alliance side)) is complete
(20028, 8, 2860, 0, 0, 0, 0), -- Condition to return true if 2860 (Master of the Wild Leather (horde side)) is complete
(20029, 8, 2853, 0, 0, 0, 0), -- Condition to return true if 2853 (Master of the Wild Leather (alliance side)) is complete
(20017, -1, 379, 20000, 20008, 0, 0), -- Condition for gossip option Wild Leather Shoulders (horde)
(20018, -1, 379, 20001, 20009, 0, 0), -- Condition for gossip option Wild Leather Vest (horde)
(20019, -1, 379, 20002, 20010, 0, 0), -- Condition for gossip option Wild Leather Helmet (horde)
(20020, -1, 379, 20013, 20011, 0, 0), -- Condition for gossip option Wild Leather Boots (horde)
(20021, -1, 379, 20014, 20012, 0, 0), -- Condition for gossip option Wild Leather Leggings (horde)
(20030, -1, 379, 20028, 20027, 0, 0), -- Condition for gossip option Wild Leather Cloak (horde)
(20022, -1, 379, 20004, 20008, 0, 0), -- Condition for gossip option Wild Leather Shoulders (alliance)
(20023, -1, 379, 20005, 20009, 0, 0), -- Condition for gossip option Wild Leather Vest (alliance)
(20024, -1, 379, 20006, 20010, 0, 0), -- Condition for gossip option Wild Leather Helmet (alliance)
(20025, -1, 379, 20015, 20011, 0, 0), -- Condition for gossip option Wild Leather Boots (alliance)
(20026, -1, 379, 20016, 20012, 0, 0), -- Condition for gossip option Wild Leather Leggings (alliance)
(20031, -1, 379, 20029, 20027, 0, 0); -- Condition for gossip option Wild Leather Cloak (alliance)

-- Set quest requirement for 2858 (Wild Leather Boots (horde side)) to condition that requires previous 3 quests
UPDATE `quest_template` SET `RequiredSkillValue` = 200, `PrevQuestId` = 0, `RequiredCondition` = 20003 WHERE `entry` = 2858;

-- Set quest requirement for 2859 (Wild Leather Leggings (horde side)) to condition that requires previous 3 quests
UPDATE `quest_template` SET `RequiredSkillValue` = 200, `PrevQuestId` = 0, `RequiredCondition` = 20003 WHERE `entry` = 2859;

-- Set quest requirement for 2851 (Wild Leather Boots (alliance side)) to condition that requires previous 3 quests
UPDATE `quest_template` SET `RequiredSkillValue` = 200, `PrevQuestId` = 0, `RequiredCondition` = 20007 WHERE `entry` = 2851;

-- Set quest requirement for 2852 (Wild Leather Leggings (alliance side)) to condition that requires previous 3 quests
...
-- Broadcast text for all gossip options and spells to teach the patterns already exist, but weren't implemented
