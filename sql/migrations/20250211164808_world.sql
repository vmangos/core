...
DELETE FROM `pool_gameobject` WHERE `guid` IN (34669, 41966, 34670, 41967, 34684, 41976, 34686, 41978, 34687, 41979, 34688, 41980, 34698, 41989, 34702, 41992, 34703, 41995, 41999, 34730, 42005, 34735, 41985);
DELETE FROM `pool_pool` WHERE `pool_id` IN (1860, 1861, 1875, 1877, 1878, 1879, 1889, 1893, 1894, 1902, 1921, 2856);
DELETE FROM `gameobject` WHERE `guid` IN (41968, 41969, 41970, 41971, 41972, 41973, 41974, 41975, 41977, 41981, 41982, 41983, 41984, 41986, 41987, 41988, 41990, 41991, 41993, 41994, 41996, 41997, 41998, 42000, 42001, 42002, 42003, 42004, 42006, 42007, 42008, 84126, 84127, 84128, 84129, 84130, 84131, 207);
