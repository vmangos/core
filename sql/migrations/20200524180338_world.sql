...
-- set faction for defias rioter and enable event_ai
UPDATE `creature_template` SET `ai_name` = "EventAI", `faction` = 17 WHERE entry = 5043;
...
(302709, 5043, 0, 0, 0, 0, 0, 5043, -8709.77, 889.942, 76.3504, 3.84802, 25, 25, 0, 100, 100, 0, 0, 0, 0, 10);
...
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES (504301, 0, 10, 5043, 15000, 0, 0, 0, 0, 0, 0, 1, 504302, 6, 6, -8713.28, 884.912, 76.351, 3.84802, 0, 'jailbreak - summon left lane 1');
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES (504301, 0, 10, 5043, 15000, 0, 0, 0, 0, 0, 0, 1, 504303, 6, 6, -8715.18, 887.661, 76.3511, 3.84802, 0, 'jailbreak - summon right lane 1');
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES (504301, 0, 10, 5043, 15000, 0, 0, 0, 0, 0, 0, 1, 504301, 6, 6, -8714.18, 886.3988, 76.3511, 3.84802, 0, 'jailbreak - summon middle lane 2');
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES (504301, 0, 10, 5043, 15000, 0, 0, 0, 0, 0, 0, 1, 504301, 6, 6, -8712.94, 887.305, 76.3511, 3.84802, 0, 'jailbreak - summon middle lane 3');
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES (504301, 0, 10, 5043, 15000, 0, 0, 0, 0, 0, 0, 1, 504302, 6, 6, -8711.87, 885.939, 76.3511, 3.84802, 0, 'jailbreak - summon left lane 2');
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES (504301, 0, 10, 5043, 15000, 0, 0, 0, 0, 0, 0, 1, 504303, 6, 6, -8714.06, 888.635, 76.3511, 3.84802, 0, 'jailbreak - summon right lane 2');
