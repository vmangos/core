...
-- Head of Onyxia Spawned OR Head of Nefarian Spawned
INSERT INTO `conditions` (`condition_entry`, `type`, `value1`, `value2`, `value3`, `value4`, `flags`) VALUES (399, -2, 397, 398, 0, 0, 0);

-- Assign gossip menu to Major Mattingly.
DELETE FROM `npc_gossip` WHERE `npc_guid`=79854;
INSERT INTO `gossip_menu` VALUES (5753, 6937, 399);
