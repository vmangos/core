...
UPDATE `creature_template` SET `minhealth`=2012, `maxhealth`=2012, `speed_walk`='0.25', `speed_run`='0.285715',`ScriptName`='soldier_frozen_wastes_ai', `unit_flags`=0/*256passive*/ WHERE `entry`=16427;
